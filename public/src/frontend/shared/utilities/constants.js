...
/**
 * Game status constants for tracking chess game state (frontend copy)
 * @readonly
 * @enum {string}
 */
...
/**
 * UI rendering constants for the chess board display (frontend copy)
 * @readonly
 * @enum {number}
 */
...
/**
 * Chess board coordinate constants (frontend copy)
